    ...
    (async () => {
        ...
        request(options, async function (error, response) {
            ...
            if (thisistoday) {
                ...
                await new Pageres({ filename: datecheck.substring(0, 2) + '-' + datecheck.substring(2, 4) + '-' + datecheck.substring(4, 8), launchOptions: {  args: ['--no-sandbox', '--disable-setuid-sandbox', '--no-first-run', '--disable-extensions'] } })
