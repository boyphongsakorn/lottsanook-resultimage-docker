    ...
    (async () => {
        ...
        request(options, async function (error, response) {
            ...
            if (thisistoday) {
                ...
                await new Pageres({ filename: "<%= date %>", launchOptions: { executablePath: '/usr/bin/chromium-browser', args: ['--no-sandbox', '--disable-setuid-sandbox', '--no-first-run', '--disable-extensions'] } })
