...
fastify.get('/', async (request, reply) => {
    ...
    if (request.query.bgimg) {
        ...
        await page.goto('data:text/html,' + headercap + '<div style="background: rgb(255,230,0);background: linear-gradient(254deg, rgba(255,230,0,1) 0%, rgba(0,146,210,1) 100%);margin-top: 65px;width: 2048px;text-align: center;"><h1 style="font-size: 80px;margin-bottom: 0px;padding-bottom: 0px;">ผลรางวัลสลากกินแบ่งรัฐบาล</h1><h2 style="font-size: 50px;margin-top: 0px;padding-top: 0px;">เมื่อประจำวันที่ 16 สิงหาคม 2565</h2></div><h2 style="font-size: 80px;margin-left: 845px;margin-top: 100px;margin-bottom: 0px;">รางวัลที่ 1</h2><h2 style="font-size: 17vw;margin-left: 250px;margin-top: -65px;margin-right: 650px;text-align: center;margin-bottom: 0px;">000000</h2><h2 style="margin-left: 1095px;margin-top: -20px;font-size: 75px;margin-bottom: 15px;">เลขท้าย สองตัว</h2><h2 style="margin-left: 1200px;font-size: 450px;margin-top: -90px;margin-bottom: 0px;">00</h2><h2 style="margin-top: -765px;margin-left: 125px;font-size: 60px;margin-bottom: 0px;">เลขหน้า สามตัว</h2><h2 style="font-size: 7vw;margin-left: 160px;margin-top: -15px;">000 | 000</h2><h2 style="margin-left: 125px;margin-top: -90px;font-size: 60px;margin-bottom: 0px;">เลขท้าย สามตัว</h2><h2 style="font-size: 7vw;margin-left: 160px;margin-top: -10px;">000 | 000</h2>');
        //await page.waitForTimeout(1000);
        const image = await page.screenshot();
